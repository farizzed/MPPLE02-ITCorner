      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            $a=0;
            $query="SELECT id_artikel, judul_artikel, isi_artikel, username, kategori_artikel, DATE_FORMAT(tanggal, '%d-%m-%Y - %H:%i') AS tanggal from artikel where status='1' order by id_artikel desc";
