        ...
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <?php 
              ...
              $apa = $_GET['id'];
              $query = "select id_pertanyaan, judul_pertanyaan, username, isi_pertanyaan, kategori_pertanyaan, DATE_FORMAT(tanggal, '%d-%m-%Y - %H:%i') AS tanggal from pertanyaan where id_pertanyaan = '$apa' ";
