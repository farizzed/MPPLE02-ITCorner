      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            $a=0;
            $query="select a.id_artikel, a.judul_artikel, a.kategori_artikel, DATE_FORMAT(a.tanggal, '%d-%m-%Y - %H:%i') AS tanggal , u.nama, a.isi_artikel from artikel as a,user as u where a.status='1' && a.username=u.username && a.kategori_artikel='Hardware' order by a.id_artikel desc LIMIT $startAt, $numContent";
        ...
        while($row=mysql_fetch_assoc($rows))
        {
          ...
          echo'
            ...
            <h5>'.$row['kategori_artikel'].' | '.$potong_tanggal.' | '.$row['nama'].'</h5>
            <p align="left">
                '.$potong_artikel.' 
                <br>
            ...
            <label>
            <input type="submit" name="konfirmasi" value="Baca selengkapnya" class="btn btn-success">';
