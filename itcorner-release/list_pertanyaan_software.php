      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            $que = "SELECT COUNT(*) as count FROM `pertanyaan` WHERE status='1' AND kategori_pertanyaan='Software'";
            ...
            $query="select p.id_pertanyaan, p.judul_pertanyaan, p.kategori_pertanyaan, u.nama, DATE_FORMAT(p.tanggal, '%d-%m-%Y - %H:%i') AS tanggal , u.nama, p.isi_pertanyaan from pertanyaan as p,user as u where p.username=u.username && p.status='1' && p.kategori_pertanyaan='Software' order by p.id_pertanyaan desc LIMIT $startAt, $numContent";
