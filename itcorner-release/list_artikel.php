      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            <h3 align="left">Artikel Terbaru</h3>
            <hr>
            <?php 
            ...
            $a=0;
            $query="select a.id_artikel, a.judul_artikel, a.kategori_artikel, DATE_FORMAT(a.tanggal, '%d-%m-%Y - %H:%i') AS tanggal , u.nama, a.isi_artikel from artikel as a,user as u where a.status='1' && a.username=u.username order by a.id_artikel desc LIMIT $startAt, $numContent";
