      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            $a=0;
            $query="select p.id_pertanyaan, p.judul_pertanyaan, p.kategori_pertanyaan, DATE_FORMAT(p.tanggal, '%d-%m-%Y - %H:%i') AS tanggal , u.nama, p.isi_pertanyaan from pertanyaan as p,user as u where p.username=u.username && p.status='1' order by p.id_pertanyaan desc LIMIT $startAt, $numContent";
