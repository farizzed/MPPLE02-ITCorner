...
<html>
<head>
	<title>Daftar Artikel Hardware | IT Corner - Forum IT Terkini!</title>
    ...
    <div class="col-md-5 col-md-offset-2">
      ...
      <div class="col-md-12">
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px"><span class="glyphicon glyphicon-list"></span> Daftar Artikel Hardware</p>
        </div>
          <div class="panel-body">
            ...
            $que = "SELECT COUNT(*) as count FROM `artikel` WHERE status='1' AND kategori_artikel='Hardware'";
            ...
            echo '<span></a>';
            $query="select a.kunci, a.jumlah_komentar,a.id_artikel, a.judul_artikel, DATE_FORMAT(a.tanggal, '%d-%m-%Y - %H:%i') AS tanggal , u.nama from artikel as a,user as u where a.status='1' && a.username=u.username && a.kategori_artikel='Hardware' order by a.id_artikel desc LIMIT $startAt, $numContent";
        ...
        while($row=mysql_fetch_assoc($rows))
        {
          ...
          echo'
              <a href="isi_artikel.php?id='.$kode.'" class="list-group-item">
                  ...
                  <h5 class="list-group-item-text">'.$format_tanggal.' oleh '.$row['nama'].'<br>
                  ';
          ...
          //- end of pagination -//
            ...
            echo '<div class="list-group">
                ...
                <span class="glyphicon glyphicon-stats"></span>
                  &nbsp;Artikel Terpopuler - <i>Hardware</i>
                </a>';
            $query="select a.kunci, a.jumlah_komentar, a.id_artikel, a.judul_artikel, DATE_FORMAT(a.tanggal, '%d-%m-%Y - %H:%i') AS tanggal_woy , u.nama, a.isi_artikel, a.jumlah_komentar, a.tanggal from artikel as a,user as u where a.status='1' && a.username=u.username && a.kategori_artikel='Hardware' ORDER BY `a`.`jumlah_komentar` DESC, `a`.`tanggal` DESC LIMIT 0 , 5";
            $rows=mysql_query($query);
            while($row=mysql_fetch_assoc($rows))
            {
              $kode = $row['id_artikel'];
