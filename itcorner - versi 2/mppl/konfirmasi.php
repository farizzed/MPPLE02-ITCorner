...
<html>
<head>
	<title>Konfimasi konten | IT Corner - Forum IT Terkini!</title>
    ...
    <div class="row" style="padding-top:100px;">
      <div class="col-md-12">
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px"><span class="glyphicon glyphicon-check"></span> Konfirmasi konten</p>
        </div>
