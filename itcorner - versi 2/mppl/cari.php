...
<html>
<head>
  <title>Pencarian |IT Corner - Forum IT Terkini!</title>
    ...
    <div class="row" style="padding-top:100px;">
      <div class="col-md-12">
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> Pencarian</p>
        </div>
          ...
          <div role="tabpanel">
            ...
            if($countArtikel != 0)
            {
              ...
              echo ''.$countArtikel.' konten ditemukan';
              echo '<span class="pull-right">Halaman '.$pageArtikel.' dari '.$totalpageArtikel.'</span>
              </a>';
            }
            ...
            echo'
              <a href="isi_artikel.php?id='.$kode.'" class="list-group-item">
                  <h4 class="list-group-item-heading">'.$row['judul_artikel'].'</h4>
        ...
        ?>
            ...
            echo '<br><div class="list-group">
                    <a class="list-group-item active clearfix">';
            echo ''.$countPertanyaan.' konten ditemukan';
            echo '<span class="pull-right">Halaman '.$pagePertanyaan.' dari '.$totalpagePertanyaan.'</span></a>';
            }
            ...
            while($row=mysql_fetch_assoc($rows))
            {
              ...
              <a href="isi_pertanyaan.php?id='.$kode.'" class="list-group-item">
                  <h4 class="list-group-item-heading">'.$row['judul_pertanyaan'].'</h4>
