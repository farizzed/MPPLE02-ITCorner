...
<html>
<head>
	<title>Daftar | IT Corner - Forum IT Terkini!</title>
    ...
    <div class="row" style="padding-top:30px;">
      ...
      <p align="center"><img src="itcorner-hitam.png" style="align:center;"></p>
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px;"><span class="glyphicon glyphicon-edit"></span> Daftar</p>
        </div>
            ...
            <label class="control-label">Ketiklah huruf yang tertera pada gambar!</label>
              ...
              <div class="controls">
                ...
                <div class="pull-right">
                  <button class="btn btn-success btn-lg" type="submit"><span class="glyphicon glyphicon-check"></span> Daftar</button>
                  <?php
