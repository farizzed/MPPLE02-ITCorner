...
<html>
<head>
  <title>Riwayat Member | IT Corner - Forum IT Terkini!</title>
    ...
    <div class="row" style="padding-top:100px;">
      <div class="col-md-12">
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px"><span class="glyphicon glyphicon-briefcase"></span> Riwayat Member</p>
        </div>
          ...
          <title>Pilih bulan</title>Filter konten
            ...
            <select class="option-control" name="bulan" data-toggle="tooltip" data-placement="top" title="Pilih bulan">
                  ...
                  <button type="submit" class="btn btn-success" id="bulan" ><span class="glyphicon glyphicon-ok"></span> Pilih</button>
                  <a href="riwayat.php?aksi=semua"> <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Menampilkan semua artikel dan pertanyaan yang telah dipublikasikan"><span class="glyphicon glyphicon-list-alt"></span> Tampilkan semua</button></a>
                  </form>
                  <br>
                  <?php
                  if(isset($_GET['bulan']))
                       ...
                       $query="SELECT id_artikel, judul_artikel, kategori_artikel, DATE_FORMAT(tanggal, '%d-%m-%Y - %H:%i') AS tanggal from artikel where status='1' and username='$n' and substr(tanggal,6,2)='$x' and substr(tanggal,1,4)='$t' order by tanggal desc";
                             ...
                             while($row = mysql_fetch_assoc($rows)){
                              ...
                              $id = $row['id_artikel'];
                                ...
                                echo '<td><a href="isi_artikel.php?location='.$loc.'&id='.$id.'">' . $row['judul_artikel'] . "</a></td>";
