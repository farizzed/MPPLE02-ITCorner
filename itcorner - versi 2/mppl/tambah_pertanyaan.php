...
<html>
<head>
  <title>Tambah Pertanyaan | IT Corner - Forum IT Terkini!</title>
...
<div class="row" style="padding-top:100px;">
      <div class="col-md-12 ">
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px"><span class="glyphicon glyphicon-plus"></span> Tambah Pertanyaan</p>
        </div>
          ...
          <?php
           ...
           ?>
          <form id="kirim" action="tambah_pertanyaanquery.php" method="POST">
      <div id="isianjudul" class="form-group">
            ...
            <div id="isian" class="form-group">
              <label class="control-label">Deskripsi - <small><i>Berikan deskripsi yang mendukung pertanyaan anda</i></small></label>
              <div class="panel panel-default">
                  <div class="panel-heading">
              ...
              <div class="pull-right">
                  <br><span class="fade in" id="errormsg" style="display:none;color:red;font-style:italic;font-size:16px;"></span> <button class="btn btn-success" type="submit"><span class="glyphicon glyphicon-ok"></span> Publikasikan</button>
              </div>
                </div>
                </div>
                </div>
...
$('form').submit(function () {
  ...
  {
    if (document.getElementById("isi").value != "" || document.getElementById("judul").value != "")
    {
        return 'Pertanyaan belum dipublikasi. Isian akan hilang jika anda beralih dari halaman ini.';
    }
  };
  function addLink()
  {
