<?php
	...
	{
		$isi = nl2br($_POST['isi']);
		if (mysql_query("insert into pertanyaan (username,judul_pertanyaan,isi_pertanyaan,kategori_pertanyaan,status) values ('$username','$_POST[judul]','$isi','$_POST[kategori]','0')"))
		{
