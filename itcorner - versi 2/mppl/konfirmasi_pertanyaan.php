...
<?php
    ...
    $query = "select a.judul_pertanyaan from pertanyaan as a where a.id_pertanyaan=".$apa."";
    ...
    <div class="row" style="padding-top:100px;">
      <div class="col-md-12">
        ...
        <div class="panel-heading">
          <p class="panel-title" style="font-size:18px"><span class="glyphicon glyphicon-check"></span> Konfirmasi Pertanyaan</p>
        </div>
          <div class="panel-body">
            <?php 
              ...
              echo '<div class="alert alert-info">
                ...
                &nbsp;
                <a onclick="doConfirmKonfir()"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Konfirmasi pertanyaan</button></a>
                &nbsp;
                <a onclick="doConfirmHapus()"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Hapus pertanyaan</button></a>
                </h5></div>';
