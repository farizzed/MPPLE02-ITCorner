      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            $query="SELECT id_artikel, judul_artikel, isi_artikel, username, kategori_artikel, DATE_FORMAT(tanggal, '%d-%m-%Y - %H:%i') AS tanggal from artikel where status='1' AND kategori_artikel='Software' order by id_artikel desc";
        ...
        while($row=mysql_fetch_assoc($rows))
        {
          ...
          echo'
            ...
            <h5>'.$row['kategori_artikel'].' | '.$format_tanggal.' | '.$row['username'].'</h5>
            <p align="left">
                '.$potong_artikel.' 
                <br>
