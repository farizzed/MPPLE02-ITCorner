      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-body">
            ...
            $a=0;
            $query="SELECT id_pertanyaan, judul_pertanyaan, isi_pertanyaan, username, kategori_pertanyaan, DATE_FORMAT(tanggal, '%d-%m-%Y - %H:%i') AS tanggal from pertanyaan where status='1' order by id_pertanyaan desc";
